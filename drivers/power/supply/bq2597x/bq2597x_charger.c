...
//EXPORT_SYMBOL(bq2597x_enable_charge);
...
//EXPORT_SYMBOL(bq2597x_enable_wdt);
...
//EXPORT_SYMBOL(bq2597x_enable_batovp);
...
//EXPORT_SYMBOL(bq2597x_set_batovp_th);
...
//EXPORT_SYMBOL(bq2597x_enable_batovp_alarm);
...
//EXPORT_SYMBOL(bq2597x_set_batovp_alarm_th);
...
//EXPORT_SYMBOL(bq2597x_enable_batocp);
...
//EXPORT_SYMBOL(bq2597x_set_batocp_th);
...
//EXPORT_SYMBOL(bq2597x_enable_batocp_alarm);
...
//EXPORT_SYMBOL(bq2597x_set_batocp_alarm_th);
...
//EXPORT_SYMBOL(bq2597x_set_busovp_th);
...
//EXPORT_SYMBOL(bq2597x_enable_busovp_alarm);
...
//EXPORT_SYMBOL(bq2597x_set_busovp_alarm_th);
...
//EXPORT_SYMBOL(bq2597x_enable_busocp);
...
//EXPORT_SYMBOL(bq2597x_set_busocp_th);
...
//EXPORT_SYMBOL(bq2597x_enable_busocp_alarm);
...
//EXPORT_SYMBOL(bq2597x_set_busocp_alarm_th);
...
//EXPORT_SYMBOL(bq2597x_enable_batucp_alarm);
...
//EXPORT_SYMBOL(bq2597x_set_batucp_alarm_th);
...
//EXPORT_SYMBOL(bq2597x_set_acovp_th);
...
//EXPORT_SYMBOL(bq2597x_enable_bat_therm);
...
//EXPORT_SYMBOL(bq2597x_set_bat_therm_th);
...
//EXPORT_SYMBOL(bq2597x_enable_bus_therm);
