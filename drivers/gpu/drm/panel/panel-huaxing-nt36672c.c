...
static inline
struct j20s_42_02_0b_dsc *to_j20s_42_02_0b_dsc(struct drm_panel *panel)
{
	return container_of(panel, struct j20s_42_02_0b_dsc, panel);
}

static void j20s_42_02_0b_dsc_reset(struct j20s_42_02_0b_dsc *ctx)
{
...
static int j20s_42_02_0b_dsc_on(struct j20s_42_02_0b_dsc *ctx)
{
...
static int j20s_42_02_0b_dsc_off(struct j20s_42_02_0b_dsc *ctx)
{
	struct mipi_dsi_device *dsi = ctx->dsi;
...
static int j20s_42_02_0b_dsc_prepare(struct drm_panel *panel)
{
	struct j20s_42_02_0b_dsc *ctx = to_j20s_42_02_0b_dsc(panel);
	...
	j20s_42_02_0b_dsc_reset(ctx);

	ret = j20s_42_02_0b_dsc_on(ctx);
	if (ret < 0) {
...
static int j20s_42_02_0b_dsc_unprepare(struct drm_panel *panel)
{
	struct j20s_42_02_0b_dsc *ctx = to_j20s_42_02_0b_dsc(panel);
	struct device *dev = &ctx->dsi->dev;
	int ret;
...
static const struct drm_display_mode j20s_42_02_0b_dsc_mode = {
...
static int j20s_42_02_0b_dsc_get_modes(struct drm_panel *panel,
				       struct drm_connector *connector)
{
	struct drm_display_mode *mode;

	mode = drm_mode_duplicate(connector->dev, &j20s_42_02_0b_dsc_mode);
	if (!mode)
		return -ENOMEM;
...
static const struct drm_panel_funcs j20s_42_02_0b_dsc_panel_funcs = {
	.prepare = j20s_42_02_0b_dsc_prepare,
	.unprepare = j20s_42_02_0b_dsc_unprepare,
	.get_modes = j20s_42_02_0b_dsc_get_modes,
};

static int j20s_42_02_0b_dsc_probe(struct mipi_dsi_device *dsi)
{
	struct device *dev = &dsi->dev;
	struct j20s_42_02_0b_dsc *ctx;
	int ret;
	...
	drm_panel_init(&ctx->panel, dev, &j20s_42_02_0b_dsc_panel_funcs,
...
static void j20s_42_02_0b_dsc_remove(struct mipi_dsi_device *dsi)
{
	struct j20s_42_02_0b_dsc *ctx = mipi_dsi_get_drvdata(dsi);
	int ret;
...
static const struct of_device_id j20s_42_02_0b_dsc_of_match[] = {
	{ .compatible = "huaxing,nt36672c" }, // FIXME
	{ /* sentinel */ }
};
MODULE_DEVICE_TABLE(of, j20s_42_02_0b_dsc_of_match);

static struct mipi_dsi_driver j20s_42_02_0b_dsc_driver = {
	.probe = j20s_42_02_0b_dsc_probe,
	.remove = j20s_42_02_0b_dsc_remove,
	.driver = {
		.name = "panel-j20s-42-02-0b-dsc",
		.of_match_table = j20s_42_02_0b_dsc_of_match,
	},
};
module_mipi_dsi_driver(j20s_42_02_0b_dsc_driver);
